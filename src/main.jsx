...
const PRODUCTS = [
  {
    ...
    accent: "#111111",
    images: [
      import.meta.env.BASE_URL + "shoes/cloudwalk-main-4k.png",
      import.meta.env.BASE_URL + "shoes/cloudwalk-side-left-4k.png",
      import.meta.env.BASE_URL + "shoes/cloudwalk-side-right-4k.png",
    ],
  ...
  },
  {
    ...
    accent: "#111111",
    images: [
      import.meta.env.BASE_URL + "shoes/shadow-main-4k.png",
      import.meta.env.BASE_URL + "shoes/shadow-side-left-4k.png",
      import.meta.env.BASE_URL + "shoes/shadow-side-right-4k.png",
    ],
    sizes: [7, 8, 9, 10, 11, 12],
  },
  {
    ...
    accent: "#1264ff",
    images: [
      import.meta.env.BASE_URL + "shoes/aeroflow-main-4k.png",
      import.meta.env.BASE_URL + "shoes/aeroflow-side-left-4k.png",
      import.meta.env.BASE_URL + "shoes/aeroflow-side-right-4k.png",
    ],
    sizes: [7, 8, 9, 10, 11, 12],
  },
];
